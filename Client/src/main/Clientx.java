...
public class Clientx {
	...
	private void captureAudio() {
	    try {
	        sock = new Socket("192.168.1.11", 500);
	        ...
	        Mixer mixer = AudioSystem.getMixer(mixerInfo[5]);    //Select Available Hardware Devices for the micro, for my Notebook it is number 3.
